...
export const DropdownItem = (props: { href?: string } & HeadlessMenuItemProps<"button">) => (
  <HeadlessMenuItem
...
export const DropdownHeader = ({ className, ...props }: React.ComponentPropsWithoutRef<"div">) => (
  <div {...props} className={clsx(className, "col-span-5 px-3.5 pb-1 pt-2.5 sm:px-3")} />
);

export const DropdownSection = ({ className, ...props }: HeadlessMenuSectionProps) => (
  <HeadlessMenuSection
    {...props}
    className={clsx(
      className,
...
export const DropdownHeading = ({ className, ...props }: HeadlessMenuHeadingProps) => (
  <HeadlessMenuHeading
    {...props}
    className={clsx(
      className,
...
export const DropdownSeparator = ({ className, ...props }: HeadlessMenuSeparatorProps) => (
...
export const DropdownLabel = ({ className, ...props }: HeadlessLabelProps) => (
  <HeadlessLabel
    {...props}
    data-slot="label"
...
export const DropdownDescription = ({ className, ...props }: HeadlessDescriptionProps) => (
  <HeadlessDescription
